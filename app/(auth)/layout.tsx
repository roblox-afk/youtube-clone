export default function AuthLayout({
	...
	return (
		<div className="flex justify-end items-center h-screen w-screen">
			...
			<main className="mr-16 ~sm/lg:~w-96/[32rem] h-[49rem] rounded-3xl bg-white bg-opacity-5 border-neutral-700 shadow-popOut shadow-neutral-400 border p-10 backdrop-blur-3xl">
				{children}
			</main>
		</div>
	);
